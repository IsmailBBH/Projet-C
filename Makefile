...
GOD: main.c affichage.o possibilites.o coups.o save_load.o
	gcc -Wall `pkg-config --cflags MLV` `pkg-config --libs-only-other --libs-only-L MLV` main.c possibilites.o affichage.o coups.o save_load.o -o GOD `pkg-config --libs-only-l MLV`
